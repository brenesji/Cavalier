...
<center><h4><i class="icon-plus-sign icon-large"></i> Agregar Producto o Servicio</h4></center>
<hr>
<div id="ac">
<span>Nombre del Servicio: </span><input type="text" style="width:265px; height:30px;" name="code" ><br>
<span>Fecha Llegada: </span><input type="date" style="width:265px; height:30px;" name="date_arrival" /><br>
<span>Fecha Expiracion: </span><input type="date" value="<?php echo date ('M-d-Y'); ?>" style="width:265px; height:30px;" name="exdate" /><br>
