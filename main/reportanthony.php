...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a href="barberreport.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i> Por Barbero</a>                </li>
...
<form action="reportanthony.php" method="get">
<center><strong>Desde : <input type="text" style="width: 223px; padding:14px;" name="d1" class="tcal" value="" /> Hasta: <input type="text" style="width: 223px; padding:14px;" name="d2" class="tcal" value="" />
 <input type="button" value="Andres" class="btn btn-info" style="width: 123px; height:35px; margin-top:-8px;margin-left:8px;" id="btnHome" onClick="document.location.href='reportandres.php?d1=&d2='" />

 <button class="btn btn-info" style="width: 123px; height:35px; margin-top:-8px;margin-left:8px;" type="submit"><i class="icon icon-search icon-large"></i> Anthony</button>
 <input type="button" value="Giovanny" class="btn btn-info" style="width: 123px; height:35px; margin-top:-8px;margin-left:8px;" id="btnHome" onClick="document.location.href='reportgiova.php?d1=&d2='" />
 <input type="button" value="Robert" class="btn btn-info" style="width: 123px; height:35px; margin-top:-8px;margin-left:8px;" id="btnHome" onClick="document.location.href='reportrobert.php?d1=&d2='" />
 <input type="button" value="Yatnnael" class="btn btn-info" style="width: 123px; height:35px; margin-top:-8px;margin-left:8px;" id="btnHome" onClick="document.location.href='reportyatnael.php?d1=&d2='" />
</strong></center>
</form>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			...
			<th width="20%"> Nombre del Servicio </th>
	...
	<tbody>
			...
			<?php
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$result = $db->prepare("SELECT * FROM sales_order WHERE gen_name = 'Miguel Brenes' AND date BETWEEN :a AND :b ORDER by transaction_id DESC ");
	...
	<thead>
		<tr>
			...
			<?php
				...
				$results = $db->prepare("SELECT sum(amount) FROM sales_order WHERE gen_name = 'Miguel Brenes' AND date BETWEEN :a AND :b ");
				$results->bindParam(':a', $d1);
				$results->bindParam(':b', $d2);
				/*$results->bindParam(':j', $d2);*/
				$results->execute();
				...
				<th colspan="1" style="border-top:1px solid #999999">
			<?php 
				$resultia = $db->prepare("SELECT sum(profit) FROM sales_order WHERE gen_name = 'Miguel Brenes' AND date BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
				/*$resultia->bindParam(':j', $d3);*/
				$resultia->execute();
