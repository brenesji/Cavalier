...
<!---Aqui empieza para poder hacer floting la parte de editar la factura-->
...
<!---Aqui termina para poder hacer floting la parte de editar la factura-->
...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a href="salesreport.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i> Por Fecha</a>                </li>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			<th width="10%"> ID Transaccion </th>
			<th width="10%"> Fecha Transaccion</th>
			<th width="13%"> Nombre del Barbero </th>
			<th width="10%"> Numero de Factura </th>
			<th width="10%"> Monto </th>
			<th width="12%"> Pago Barbero </th>
			<th width="12%"> Pago Barberia </th>
			<th width="12%"> Impuesto </th>  <!---Agrego el campo impuesto-->
	...
	<tbody>
			...
			<!---Agrego el campo impuesto-->
			<td><?php
			$zxclp=$row['tax'];
			echo formatMoney($zxclp, true);
			?></td>
			
			<td><a title="Click To Edit" rel="facebox" href="editsales.php?id=<?php echo $row['invoice']; ?>"><button class="btn btn-warning btn-mini"><i class="icon-edit"></i> Editar </button></a>
			<a href="deletesales.php" id="<?php echo $row['invoice']; ?>" class="delbutton" title="Click To Delete"><button class="btn btn-danger btn-mini"><i class="icon-trash"></i> Borrar</button></a></td>
			</tr>
			<?php
				}
			?>
	...
	<thead>
		<tr>
			...
			<th colspan="1" style="border-top:1px solid #999999">
			<?php 
				$resultia = $db->prepare("SELECT sum(tax) FROM sales_order WHERE date BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
				$resultia->execute();
				for($i=0; $cxz = $resultia->fetch(); $i++){
