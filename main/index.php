...
?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
              ...
              <li class="active"><a href="#"><i class="icon-dashboard icon-2x"></i> Modulo Principal </a></li> 
	...
	<div class="contentheader">
			<i class="icon-dashboard"></i> Modulo Principal
			</div>
			<ul class="breadcrumb">
			<li class="active">San Jose, Mall San Pedro</li>
			</ul>
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#fff;"><center>Barberia Cavalier</center></font>
<div id="mainmain">
...
<a href="supplier.php"><i class="icon-group icon-2x"></i><br> Barberos</a> 
<!--Elimino a Cashier-->    
<!--<a href="salesreportcashier.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i><br> Reportes por Fecha</a>-->
<!--<a href="barberreport.php?d1=0&d2=0&d3=0"><i class="icon-bar-chart icon-2x"></i><br> Reportes por Barbero</a>  -->
<a href="citas.php"><i class="icon-list-alt icon-2x"></i><br> Citas</a>     
...
<a href="customer.php"><i class="icon-group icon-2x"></i><br> Clientes</a>     
<a href="supplier.php"><i class="icon-group icon-2x"></i><br> Barberos</a>     
<a href="salesreport.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i><br> Reportes por Fecha</a>
<a href="barberreport.php?d1=0&d2=0&d3=0"><i class="icon-bar-chart icon-2x"></i><br> Reportes por Barbero</a>  
<a href="citas.php"><i class="icon-list-alt icon-2x"></i><br> Citas</a>     
<a href="../index.php"><font color="red"><i class="icon-off icon-2x"></i></font><br> Salir</a>    
<?php
